					...
					<li 
						<?php if($url == "Barangbaru") { 
							echo 'class="active open"'; 
						 	...
						 	echo 'class="active open"';
						 }elseif($url == "Tambahstock" || $url == "Upload" ){
						 	echo 'class="active open"';
						 }
						 	 ?> >
						...
						<ul class="submenu">
							...
							<li <?php if($url == "Barangbaru" || $url == "Upload" ) { echo 'class="active"'; } ?> >
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="#">
								<?php if($url == "Barangbaru" || $url == "Upload" ){ 
									echo "Master Data";
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							...
							Apoteker &copy; Aji Purnama</span>
						</span>
