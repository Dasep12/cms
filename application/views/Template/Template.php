  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?= $url == "Post" ? 'active' : '' ; ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?= $url1 == "tambahPost" ? 'active' : '' ; ?>" >
				<a href="<?= base_url('wp-admin/Post/tambahPost') ?>">
					<i class="fa fa-circle-o"></i> Tambah Postingan
				</a>
			</li>
        ...
        <li class="treeview <?= $url == "Kategori" ? 'active' : '' ; ?>" >
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?= $url1 == "" ? 'active' : '' ; ?>">
				<a href="<?= base_url('wp-admin/Kategori') ?>">
